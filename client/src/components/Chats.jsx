...
import { aimsg, getConvo, getFriends, getUserDetails } from '../api_requests/getData';
...
const Chats = () => {
    ...
    const sendAimsg = async () => {
        try {
            const response = await aimsg();
            console.log(response);
            alert(response.message + "   " + "This message is Generated by gemini");
        }
        catch (error) {
            console.log(error);
        }
    ...
    const sendMessage = async () => {
        ...
        try {
            ...
            if (response.err) {
                ...
                setConvo([...convo, response.json]); // Assuming response contains the new message
                setMessage("");
            }
        } catch (error) {
